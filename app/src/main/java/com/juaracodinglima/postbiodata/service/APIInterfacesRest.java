...
public interface APIInterfacesRest {
    ...
    @Multipart
    @POST("biodata/add")
    Call<ModelResultAdd> addBiodata(

            @Part("nama") RequestBody podate,
            @Part("alamat") RequestBody status,
            @Part("telepon") RequestBody lat,
            @Part("lat") RequestBody lon,
            @Part("lon") RequestBody poddate,
